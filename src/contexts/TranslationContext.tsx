...
const translations = {
  ...
  el: {
    ...
    faq: {
      ...
      description: "Βρείτε απαντήσεις στις πιο συνηθισμένες ερωτήσεις μας",
      categories: {
        general: {
          title: "Γενικές Ερωτήσεις",
          questions: {
            company: {
              question: "Τι είναι η Aurex K-pital;",
              answer: "Η Aurex K-pital είναι ένας κορυφαίος οργανισμός χρηματοπιστωτικών υπηρεσιών που ειδικεύεται στην παροχή καινοτόμων επενδυτικών λύσεων και υπηρεσιών διαχείρισης περιουσίας."
            },
            services: {
              question: "Ποιες υπηρεσίες προσφέρετε;",
              answer: "Προσφέρουμε μια ολοκληρωμένη γκάμα χρηματοπιστωτικών υπηρεσιών συμπεριλαμβανομένης της διαχείρισης περιουσίας, επενδυτικής συμβουλευτικής, τραπεζικών υπηρεσιών και ασφαλιστικών προϊόντων."
            }
          }
        },
        accounts: {
          title: "Λογαριασμοί & Ταυτότητα",
          questions: {
            opening: {
              question: "Πώς μπορώ να ανοίξω λογαριασμό;",
              answer: "Μπορείτε να ανοίξετε λογαριασμό online μέσω της ασφαλούς πλατφόρμας μας ή επισκεπτόμενοι ένα από τα γραφεία μας. Θα χρειαστείτε έγκυρη ταυτότητα και απόδειξη διεύθυνσης."
            }
          }
        }
      }
