...
const translations = {
  ...
  it: {
    ...
    'menu.simulator': 'Simulatore',
    'menu.request': 'Richiesta',
    'menu.about': 'Chi siamo',
    'menu.contact': 'Contatto',
    'menu.faq': 'FAQ',
    'menu.careers': 'Carriere',
    ...
    'footer.gdpr': 'GDPR',
    'footer.rights': '© 2024 Aurex K-pital. Tutti i diritti riservati.',
    // Simulator structure
    'simulator.title': 'Simulatore di prestito',
    'simulator.subtitle': 'Calcola la tua rata mensile in pochi clic',
    'simulator.form.loanType': 'Tipo di prestito',
    'simulator.form.amount': 'Importo desiderato (€)',
    'simulator.form.duration': 'Durata (mesi)',
    'simulator.form.calculate': 'Calcola',
    'simulator.form.reset': 'Resetta',
    'simulator.result.monthlyPayment': 'Rata mensile stimata',
    'simulator.result.totalRepayment': 'Importo totale da rimborsare',
    'simulator.result.interestRate': 'Tasso d\'interesse stimato',
    'simulator.result.disclaimer': 'Stima indicativa e non vincolante.',
    // Testimonials structure
    'testimonials.title': 'Ci danno fiducia',
    'testimonials.subtitle': 'Cosa dicono i nostri clienti soddisfatti',
    'testimonials.clients.0.name': 'Jean-Marc Rousseau',
    'testimonials.clients.0.location': 'Lione, Francia',
    'testimonials.clients.0.feedback': 'Servizio veloce e professionale. Il mio prestito è stato approvato in 48 ore. Grazie Aurex K-pital!',
    'testimonials.clients.1.name': 'Amélie Blanchard',
    'testimonials.clients.1.location': 'Parigi, Francia',
    'testimonials.clients.1.feedback': 'Team competente, interfaccia semplice e assistenza davvero personalizzata.',
    'testimonials.clients.2.name': 'Thomas Bonnet',
    'testimonials.clients.2.location': 'Tolosa, Francia',
    'testimonials.clients.2.feedback': 'Il simulatore è chiaro e ho ottenuto condizioni migliori rispetto alla mia banca.',
    // Loan Request structure
    'loanRequest.title': 'Richiedi un prestito',
    'loanRequest.subtitle': 'Compila il modulo per iniziare la tua richiesta',
    'loanRequest.form.fullName': 'Nome completo',
    'loanRequest.form.email': 'Email',
    'loanRequest.form.phone': 'Telefono',
    'loanRequest.form.loanType': 'Tipo di prestito',
    'loanRequest.form.amount': 'Importo richiesto (€)',
    'loanRequest.form.duration': 'Durata desiderata (mesi)',
    'loanRequest.form.message': 'Messaggio o nota (facoltativo)',
    'loanRequest.form.submit': 'Invia richiesta',
    'loanRequest.form.success': 'Richiesta inviata con successo. Ti contatteremo entro 24 ore.',
    // Careers structure
    'careers.title': 'Unisciti al nostro team',
    'careers.subtitle': 'Stiamo costruendo il futuro della finanza europea',
    'careers.intro': 'Aurex K-pital cerca persone ambiziose e appassionate di fintech, innovazione e servizio al cliente.',
    'careers.positions.0.title': 'Consulente finanziario',
    'careers.positions.0.location': 'Parigi o da remoto',
    'careers.positions.0.type': 'Tempo pieno',
    'careers.positions.0.apply': 'Candidati',
    'careers.positions.1.title': 'Responsabile partner',
    'careers.positions.1.location': 'Lisbona o da remoto',
    'careers.positions.1.type': 'Freelance',
    'careers.positions.1.apply': 'Candidati',
    'careers.cta': 'Vedi offerte',
    // Partners structure
    'partners.title': 'I nostri partner',
    'partners.subtitle': 'Attori affidabili del mondo finanziario e tecnologico',
    'partners.logosTitle': 'Ci supportano',
    'partners.cta': 'Diventa partner',
    // Legal structure
    'legal.mentions.title': 'Note legali',
    'legal.mentions.content': 'Aurex K-pital è una società registrata nell\'Unione Europea. Tutte le informazioni legali sono disponibili su richiesta.',
    'legal.privacy.title': 'Politica sulla privacy',
    'legal.privacy.content': 'Diamo grande importanza alla protezione dei tuoi dati. Consulta la nostra politica completa sulla privacy.',
    'legal.terms.title': 'Termini e condizioni',
    'legal.terms.content': 'L\'uso di questo sito web è soggetto ai nostri termini e condizioni.',
    'legal.gdpr.title': 'GDPR',
    'legal.gdpr.content': 'In conformità con il GDPR, hai il diritto di accedere, rettificare ed eliminare i tuoi dati personali.',
    // Services structure
    'services.personalLoan.title': 'Prestiti personali',
    'services.personalLoan.description': 'Soluzioni di finanziamento ultra-personalizzate con condizioni rivoluzionarie.',
    'services.personalLoan.points.0': 'IA per tassi ottimali',
    'services.personalLoan.points.1': 'Risposta in 2h',
    'services.personalLoan.points.2': 'Massima flessibilità',
    'services.personalLoan.cta': 'Scopri',
    'services.businessLoan.title': 'Finanziamenti aziendali',
    'services.businessLoan.description': 'Porta la tua azienda all\'eccellenza con le nostre soluzioni innovative.',
    'services.businessLoan.points.0': 'Finanziamento express',
    'services.businessLoan.points.1': 'Accompagnamento esperto',
    'services.businessLoan.points.2': 'Soluzioni su misura',
    'services.businessLoan.cta': 'Scopri',
    'services.investment.title': 'Investimenti intelligenti',
    'services.investment.description': 'Ottimizzazione patrimoniale con intelligenza artificiale ed esperienza umana.',
    'services.investment.points.0': 'Portfolio intelligente',
    'services.investment.points.1': 'Consulenza premium',
    'services.investment.points.2': 'Rendimento ottimizzato',
    'services.investment.cta': 'Scopri',
    'services.insurance.title': 'Assicurazioni 360°',
    'services.insurance.description': 'Protezione totale e innovativa per tutti i tuoi progetti di vita e business.',
    'services.insurance.points.0': 'Copertura completa',
    'services.insurance.points.1': 'Gestione sinistri in 24h',
    'services.insurance.points.2': 'Supporto premium',
    'services.insurance.cta': 'Scopri',
    'services.explore': 'Esplora tutti i nostri servizi',
    footer: {
