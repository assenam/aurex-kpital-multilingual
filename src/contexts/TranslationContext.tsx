...
const translations = {
  ...
  de: {
    ...
    'testimonials.subtitle': 'Entdecken Sie die Bewertungen unserer zufriedenen Kunden',
    'testimonials.clients.0.name': 'Jean-Marc Rousseau',
    'testimonials.clients.0.location': 'Lyon, Frankreich',
    'testimonials.clients.0.feedback': 'Seriöse und schnelle Betreuung. Mein Kredit wurde in 48h genehmigt. Danke Aurex K-pital!',
    'testimonials.clients.1.name': 'Amélie Blanchard',
    'testimonials.clients.1.location': 'Paris, Frankreich',
    'testimonials.clients.1.feedback': 'Professionelles Team, einfache Benutzeroberfläche und vor allem echte persönliche Betreuung.',
    'testimonials.clients.2.name': 'Thomas Bonnet',
    'testimonials.clients.2.location': 'Toulouse, Frankreich',
    'testimonials.clients.2.feedback': 'Der Simulator ist sehr klar und ich bekam viel bessere Konditionen als bei meiner Bank.',
    // Loan Request structure
    'loanRequest.title': 'Kreditantrag stellen',
    'loanRequest.subtitle': 'Füllen Sie die unten stehenden Informationen aus, um Ihren Antrag zu starten.',
    'loanRequest.form.fullName': 'Vollständiger Name',
    'loanRequest.form.email': 'E-Mail-Adresse',
    'loanRequest.form.phone': 'Telefonnummer',
    'loanRequest.form.loanType': 'Kreditart',
    'loanRequest.form.amount': 'Gewünschter Betrag (€)',
    'loanRequest.form.duration': 'Gewünschte Laufzeit (Monate)',
    'loanRequest.form.message': 'Nachricht oder Anmerkung (optional)',
    'loanRequest.form.submit': 'Antrag senden',
    'loanRequest.form.success': 'Ihr Antrag wurde erfolgreich gesendet. Wir werden Sie innerhalb von 24h kontaktieren.',
