  ...
  fr: {
    ...
    contact: {
      ...
      legal: {
        ...
        title: { main: "Mentions", subtitle: "Légales" },
        description: "Informations légales, politiques de confidentialité et conditions d'utilisation de nos services financiers.",
        tabs: { mentions: "Mentions légales", privacy: "Confidentialité", terms: "Conditions", gdpr: "RGPD" },
        mentions: { title: "Mentions Légales", description: "Informations légales relatives à notre société et nos services", company: { title: "Informations sur la société", name: "Nom de la société", type: "Forme juridique", typeValue: "Société à responsabilité limitée (GmbH)", capital: "Capital social", address: "Adresse du siège social", register: "Numéro d'immatriculation", vat: "Numéro de TVA", siren: "Numéro SIREN" }, management: { title: "Direction", ceo: "Directeur Général", cio: "Directeur de l'Information", cro: "Directeur des Risques" }, activity: { title: "Activité", description: "Aurex K-pital est spécialisée dans les services financiers et bancaires :", services: { banking: "Services bancaires et de crédit", investment: "Conseil en investissement", insurance: "Produits d'assurance", wealth: "Gestion de patrimoine" } }, contact: { title: "Contact", phone: "Téléphone", email: "Email", hours: "Horaires d'ouverture", schedule: "Du lundi au vendredi, de 9h à 18h" }, hosting: { title: "Hébergement", description: "Le site web est hébergé par :" }, intellectual: { title: "Propriété intellectuelle", description: "Tous les contenus présents sur ce site sont la propriété exclusive d'Aurex K-pital." }, responsibility: { title: "Responsabilité", description: "Les informations sont fournies à titre indicatif et peuvent évoluer." } },
        privacy: { title: "Politique de Confidentialité", description: "Protection et traitement de vos données personnelles", lastUpdate: "Dernière mise à jour : 1er décembre 2024", compliance: "Cette politique est conforme au RGPD.", sections: { controller: { title: "1. Responsable du Traitement", content: "Aurex K-pital GmbH\nDélégué à la Protection des Données : privacy@aurex-kpital.de" }, dataCollected: { title: "2. Données Collectées", content: "• Données d'identification\n• Coordonnées\n• Données financières\n• Données de connexion" }, purposes: { title: "3. Finalités du Traitement", content: "• Services financiers\n• Évaluation solvabilité\n• Prévention fraude\n• Obligations légales" }, legalBasis: { title: "4. Base Légale", content: "• Exécution contractuelle\n• Obligation légale\n• Intérêt légitime\n• Consentement" }, dataSharing: { title: "5. Partage des Données", content: "• Partenaires bancaires\n• Organismes crédit\n• Autorités régulation\n• Prestataires techniques" }, retention: { title: "6. Conservation", content: "• Client actif : 5 ans\n• Données financières : 10 ans\n• Connexion : 13 mois\n• Marketing : 3 ans" }, rights: { title: "7. Vos Droits", content: "• Droit d'accès\n• Droit rectification\n• Droit effacement\n• Droit portabilité\n\nContact : privacy@aurex-kpital.de" }, security: { title: "8. Sécurité", content: "• Chiffrement AES-256\n• Accès contrôlé\n• Surveillance continue\n• Audits périodiques" }, transfers: { title: "9. Transferts Internationaux", content: "Transferts sécurisés avec garanties appropriées." }, contact: { title: "10. Contact", content: "Email : privacy@aurex-kpital.de\nTéléphone : +33759282004" } } },
        terms: { title: "Conditions Générales", description: "Règles d'utilisation de nos services", effectiveDate: "Date d'entrée en vigueur : 1er décembre 2024", lastUpdate: "Conditions mises à jour", sections: { object: { title: "1. Objet", content: "Définition des modalités d'utilisation des services Aurex K-pital." }, services: { title: "2. Services", content: "• Courtage prêts\n• Conseil investissement\n• Intermédiation assurance" }, registration: { title: "3. Inscription", content: "Création compte utilisateur avec informations exactes." }, obligations: { title: "4. Obligations", content: "• Usage conforme\n• Respect des droits\n• Conformité légale" }, fees: { title: "5. Tarification", content: "Services gratuits financés par commissions partenaires." }, responsibility: { title: "6. Responsabilité", content: "Responsabilité limitée aux dommages directs prouvés." }, termination: { title: "7. Résiliation", content: "Résiliation libre à tout moment." }, applicableLaw: { title: "8. Droit Applicable", content: "Droit allemand, tribunaux de Hamburg." } } },
        gdpr: { title: "Conformité RGPD", description: "Protection des données selon le RGPD", compliance: "Conformité RGPD Totale", commitment: "Respect des plus hauts standards.", sections: { principles: { title: "1. Principes", content: "• Licéité, loyauté\n• Limitation finalités\n• Minimisation données\n• Exactitude" }, rights: { title: "2. Droits", content: "• Droit information\n• Droit accès\n• Droit rectification\n• Droit effacement" }, procedures: { title: "3. Procédures", content: "• AIPD\n• Privacy by design\n• Registre traitements\n• Audits périodiques" }, breach: { title: "4. Violations", content: "• Détection 24h\n• Notification 72h\n• Mesures correctives" }, dpo: { title: "5. DPO", content: "Contact DPO : privacy@aurex-kpital.de" }, training: { title: "6. Formation", content: "Formation continue RGPD pour tous collaborateurs." }, updates: { title: "7. Mises à Jour", content: "Révision régulière pour conformité continue." } } }
      title: {
        main: "Mentions",
        subtitle: "Légales"
      },
